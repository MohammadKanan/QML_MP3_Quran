...
Item {
    ...
    Row{
        ...
        CustomImageButton{
            width: 40
            height: width
            imageSource: "qrc:/Icons/playVideo.png"
            onPressed: playerQuran.play()
        }
        CustomImageButton{
            width: 40
            height: width
            imageSource: "qrc:/Icons/pause.png"
            onPressed: playerQuran.pause()
        }
        CustomImageButton{
            width: 40
            height: width
            imageSource:  "qrc:/Icons/stop_Video.png"
    ...
    CustomImageButton{
        ...
        width: 40
        height: width
        imageSource: soundDisabled ? "qrc:/Icons/volume_off.png" : "qrc:/Icons/volume_on.png"
        anchors{
            top: parent.top
            topMargin: 20
            left: parent.left
